...
local function CreateGuiObjects()
    ...
    SelectedFrameBackgroundImage.BackgroundTransparency = -0.4
...
function methods:Update(dtScale)
    ...
    self.AnimParams.TextStroke_CurrentTransparency = CurveUtil:Expt(self.AnimParams.TextStroke_CurrentTransparency, self.AnimParams.TextStroke_TargetTransparency, self.AnimParams.TextStroke_NormalizedExptValue, dtScale)
